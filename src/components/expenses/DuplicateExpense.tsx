...
export default function DuplicateExpense({ expense, onSuccess, onDismiss, visible }: DuplicateExpenseProps) {
  ...
  return (
    <Portal>
      <Dialog 
        ...
        <Dialog.Title style={styles.title}>Duplicate Expense</Dialog.Title>
        <Dialog.Content>
