...
import QuickAddEarning from '../../src/components/earnings/QuickAddEarning';
import EarningsList, { EarningsListRef } from '../../src/components/earnings/EarningsList';
...
export default function EarningsScreen() {
  ...
  const earningsListRef = useRef<EarningsListRef>(null);
  ...
  const getDateRangeText = () => {
    if (viewType === 'all') return 'All Earnings';
  ...
  const handleAddEarningSuccess = useCallback(() => {
    setShowAddEarning(false);
    earningsListRef.current?.refresh();
    fetchTransactions();
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      <FAB
        ...
        onPress={() => setShowAddEarning(true)}
      />

      <QuickAddEarning
        visible={showAddEarning}
        onDismiss={() => setShowAddEarning(false)}
        onSuccess={handleAddEarningSuccess}
      />
    </View>
  );
}
